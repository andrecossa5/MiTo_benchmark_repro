"""
Fig 4
Gene expression analysis for PT-lung longitudinal dataset.
"""
...
# Polish adata
chosen_col = adata.obs[[chosen]]
adata.obs = adata.obs.loc[:,~adata.obs.columns.str.startswith('leiden')].join(chosen_col)
uns = {}
for x in adata.uns:
