...
# Fig 17 a,b. AFM and cell-cell distances visualization ------------------------------------#
...
fig.tight_layout()
plu.save_best_pdf_quality(fig, figsize=(4,4), path=path_figures, name='Supp_Fig_17a.pdf', dpi=1000)

# Variants
fig, ax = plt.subplots(figsize=(4,4))
mt.pl.heatmap_variants(afm, tree=tree, ax=ax, kwargs={'x_names_size':3}, cmap='afmhot_r')
fig.tight_layout()
plu.save_best_pdf_quality(fig, figsize=(4,4), path=path_figures, name='Supp_Fig_17b.pdf', dpi=1000)
