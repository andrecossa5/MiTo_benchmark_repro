# Funky heatmap: MDA_clones, MDA_lung
...
path_grouped_table <- paste0(path_main, '/results/others/Fig2/', sample, '_grouped.csv')
...
# Save
ggsave(
  paste0(path_main, '/results/figures/Supp/heatmap_', sample, '.pdf'), 
